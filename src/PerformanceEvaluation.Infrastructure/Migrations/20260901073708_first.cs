        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    PerformanceCategoryId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PerformanceCriteria", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PerformanceCriteria_PerformanceCategories_PerformanceCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EvaluatorEmployees", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EvaluatorEmployees_Users_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EvaluatorEmployees_Users_EvaluatorId",
                        column: x => x.EvaluatorId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                name: "CriterionJobPositions",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PerformanceCriterionId = table.Column<int>(type: "int", nullable: false),
                    JobPositionId = table.Column<int>(type: "int", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CriterionJobPositions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CriterionJobPositions_JobPositions_JobPositionId",
                        column: x => x.JobPositionId,
                        principalTable: "JobPositions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CriterionJobPositions_PerformanceCriteria_PerformanceCriterionId",
                        column: x => x.PerformanceCriterionId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EvaluationDetails_PerformanceCriteria_PerformanceCriterionId",
                        column: x => x.PerformanceCriterionId,
                        principalTable: "PerformanceCriteria",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CriterionJobPositions_JobPositionId",
                table: "CriterionJobPositions",
                column: "JobPositionId");

            migrationBuilder.CreateIndex(
                name: "IX_CriterionJobPositions_PerformanceCriterionId_JobPositionId",
                table: "CriterionJobPositions",
                columns: new[] { "PerformanceCriterionId", "JobPositionId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EvaluationDetails_PerformanceCriterionId",
                table: "EvaluationDetails",
                column: "PerformanceCriterionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EvaluatorEmployees_EmployeeId",
                table: "EvaluatorEmployees",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_EvaluatorEmployees_EvaluatorId_EmployeeId",
                table: "EvaluatorEmployees",
                columns: new[] { "EvaluatorId", "EmployeeId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PerformanceCriteria_PerformanceCategoryId",
